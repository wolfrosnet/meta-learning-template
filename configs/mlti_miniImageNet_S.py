...
class Config:
    ...
    num_iterations=20000 # All models were trained for 60000 iterations on a single NVIDIA Pascal Titan X GPU.
    seed=42
    ...
    use_wandb=True
    mixup_method='cutmix'
    test_ckpt_path='./checkpoint/mlti_miniImageNet-S_0822124830/best.pt'
    num_test_points=600
